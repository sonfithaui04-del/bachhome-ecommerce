...
- `Order` - Đơn hàng
- `Product` - Sản phẩm trong danh mục
- `InventoryItem` - Mặt hàng tồn kho
...
├────────────┼────────────┼────────────┼────────────┼─────────┤
│ • User     │ • Product  │ • Order    │ • Payment  │• InvItem│
...
| 2 | **Product** | CRUD danh mục, sản phẩm, variants |
...
| service-product | 8082 | postgres-product:5433 | Product management |
