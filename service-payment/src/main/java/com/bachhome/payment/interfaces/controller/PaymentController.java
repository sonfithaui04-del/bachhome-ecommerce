package com.bachhome.payment.interfaces.controller;

import com.bachhome.payment.application.service.SePayService;
import com.bachhome.payment.domain.model.Payment;
import com.bachhome.payment.domain.model.PaymentMethod;
import com.bachhome.payment.domain.model.PaymentStatus;
import com.bachhome.payment.infrastructure.repository.PaymentRepository;
...
public class PaymentController {
    ...
    private void publishPaymentConfirmedEvent(Long orderId, BigDecimal amount, String transactionId) {
        try {
            ...
            rabbitTemplate.convertAndSend("bachhome-exchange", "payment.confirmed", event);
